...
import { Star, Droplets, CheckSquare, Award, Loader2, Plus } from "lucide-react";
            ...
            <div className="border-2 border-green-600 bg-green-50 p-3 pixel-card">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-gray-800 pixel-font">
                      Plant Tomato
                    </h4>
                    <p className="text-xs text-gray-600 pixel-font">
                      Stake 1 STRK to start planting
                    </p>
                  </div>
                </div>
                <Button
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 pixel-font">
                      Accelerate growth + mutation chance
                    </p>
                  </div>
                </div>
                <Button
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <h4 className="font-bold text-xs text-gray-800 pixel-font">
                      {achievement.title}
                    </h4>
                    <p className="text-xs text-gray-600 pixel-font">
